...
@pytest.fixture()
def browser(request):
    return request.face.getoption("--browser")
...
def pytest_configure(face):
    face._metadata['project Name'] = ' nopCommerce'
    face._metadata['Module Name'] = 'Customers'
    face._metadata['Tester'] = ' Jayaram sandeep '
